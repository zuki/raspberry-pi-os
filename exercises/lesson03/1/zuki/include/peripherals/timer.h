...
// For Local timer: "BCM2836 ARM-local peripherals", p 7.

#define LTIMER_CTRL     (LPBASE+0x34)
#define LTIMER_CLR      (LPBASE+0x38)

#define LTIMER_INTERRUPT_ENABLE   (1 << 29)
#define LTIMER_ENABLE   (1 << 28)
#define LTIMER_CTRL_VALUE (LTIMER_INTERRUPT_ENABLE | LTIMER_ENABLE)

#define LTIMER_ACK      (1 << 31)
#define LTIMER_CLR_VALUE    LTIMER_ACK
